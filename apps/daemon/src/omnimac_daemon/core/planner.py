        ...
        if "delete" in g or "rm " in g or "destroy" in g:
            ...
            steps = [
                self._step(
                    ...
                    "Delete a directory",
                    "mock_delete_dir",
                    {"path": "~/projects/omnimac/build"},
                    RiskLevel.R3,
                ),
            ]
        elif "email" in g or "send" in g:
            steps = [
                self._step(0, "Read the draft", "mock_read_file", {"path": "~/draft.md"}, RiskLevel.R0),
                self._step(
                    1,
                    "Send the email",
                    "mock_send_email",
            ...
            steps = [
                self._step(0, "Run the unstable task", "mock_flaky", {"fail_times": 1}, RiskLevel.R1),
            ]
            ...
            steps = [
                ...
                self._step(
                    ...
                    "Read the README",
                    "mock_read_file",
                    {"path": "~/projects/omnimac/README.md"},
                    RiskLevel.R0,
                ),
            ]
        else:
            steps = [
                self._step(0, "Read a file", "mock_read_file", {"path": "~/notes.md"}, RiskLevel.R0),
            ]
