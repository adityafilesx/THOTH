...
|---|---|---|
| `apps/daemon/src/omnimac_daemon/tools/git_io.py` | Create | `run_git`, `GitResult`. |
| `apps/daemon/src/omnimac_daemon/tools/git_tools.py` | Create | 5 tools + `register_git_tools`. |
| `apps/daemon/src/omnimac_daemon/app.py` | Modify | `register_git_tools(registry)`. |
...
```python
# apps/daemon/src/omnimac_daemon/tools/git_io.py
...
```python
# apps/daemon/src/omnimac_daemon/tools/git_tools.py
