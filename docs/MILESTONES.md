...
- [ ] **Phase 5.4 — Accessibility embodiment:** unlocked-desktop focus capstone rerun complete; packaged test app, typed permission boundary, bounded semantic AX control, independent verification, desktop diagnostics, and real AX capstones in progress. Voice, proactivity, teach mode, long-term memory, Gmail, and Calendar remain out of scope.
