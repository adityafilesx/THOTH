...
- [x] **Phase 5.3 — hardening/final gate:** model target/tool/risk directive rejection; foreground/workspace/profile/dialogue/focus adversarial coverage; 782 daemon + 65 desktop tests pass; one live focus-restoration test skipped because the desktop was locked.
- [ ] **Phase 5.4 recommended:** unlocked-desktop focus capstone rerun and narrowly scoped Accessibility capability verification. Voice, proactivity, teach mode, long-term memory, Gmail, and Calendar remain out of scope.
