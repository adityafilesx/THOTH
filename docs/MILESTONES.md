...
- [ ] Slices 5–20 (persona, foreground control, surfaces, local STT/TTS, interruption, dialogue state, workspace profiles, resource manager, resumable tasks, proactivity, demonstration-to-draft, dogfood, hardening, final gate) — **gated / not started**.
